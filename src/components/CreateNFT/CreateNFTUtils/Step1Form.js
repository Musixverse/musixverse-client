				...
				<div className="font-semibold lg:w-1/2 font-secondary">
					<p className="text-sm">
						...
						<Tooltip
							...
							message={
								"Include featured artists and version info in the track title (if any) . Example: Knock You Down (feat. Kanye West & Ne-Yo)"
							}
							...
							<div className="flex-1 text-sm font-semibold md:text-base">
								<p className="text-sm">
									...
									<Tooltip
										labelText={<i className="pl-4 fa-solid fa-circle-info"></i>}
										message={
											"Your fans will really be interested to know the background of the song. You can write about the whole ideation process and the journey behind creating this awesome piece of music."
										}
										tooltipLocation={"bottom"}
									/>
								</p>
								...
								<div className="flex items-center">
									{coverArtArtist.avatar && (
										<div className="absolute flex items-center h-full ml-2">
											<Image
												src={coverArtArtist.avatar}
												height="30"
												width="30"
												alt="cover art artist's avatar"
