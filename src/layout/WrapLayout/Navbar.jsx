                        ...
                        <ul className="flex flex-row items-center text-sm font-medium md:space-x-8 md:mt-0 sm:text-sm">
                            ...
                            <li>
                                <ul className="relative group dropdown">
                                    ...
                                    <ul
                                        className="absolute right-0 left-auto z-10 hidden text-sm font-medium float-left py-2 m-0 mt-4 text-left list-none border-none rounded-xl shadow-lg dropdown-menu min-w-[250px] 
