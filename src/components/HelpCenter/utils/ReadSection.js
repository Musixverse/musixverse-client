	...
	return (
		<div className="flex flex-col items-center justify-center w-full">
			...
			<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mt-10">
				<div className="bg-white text-lg font-primary p-12 text-center rounded-lg cursor-pointer shadow hover:shadow-lg duration-300 dark:bg-dark-600 dark:shadow-slate-400">
