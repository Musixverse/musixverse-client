...
export default function Notartist(){
    return(
        <div className="pt-8 min-h-screen flex flex-col justify-center items-center">
            ...
            <p className="font-secondary text-sm sm:text-base text-center">You don&apos;t have an Artist account to create an NFT. you <br/> need to switch to Artist to mint songs.</p>
