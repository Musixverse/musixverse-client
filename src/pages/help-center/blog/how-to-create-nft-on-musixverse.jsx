...
const HowToCreateNFT = ({}) => {
	return (
		<>
			<Head>
				<title>Musixverse | How to create NFT on Musixverse?</title>
			...
			<div className="flex flex-col items-center justify-center w-full bg-light-200 dark:bg-dark-800">
				<div className="overflow-x-hidden justify-center w-full max-w-[768px] px-6 md:px-8 lg:px-0">
					<div className="py-36">
						...
						/>
						<BlogContent>
							Fill out the basic track details including Track Title, Track Background, and Lyrics on this page. You also need to upload the Audio
							File and Cover Art of the track here. You may follow our suggested{" "}
							<BlogLink link="https://medium.com/@musixverse/musixverse-nft-guidelines-3664764ecd7f">guidelines to create NFTs</BlogLink> as it
							would complement you while creating NFTs.
						</BlogContent>
						<BlogNoteContent>
							<ContentBold>Note:</ContentBold>{" "}
							<BlogLink link="https://musixverse.com/help-center/blog/musixverse-nft-guidelines">Musixverse NFT Guidelines</BlogLink> is the
							complementary guide to this article. It describes the standard guideline that you can follow to create your NFTs.
						</BlogNoteContent>
						...
						/>
						<BlogContent>
							What is the story behind this song? Where did the idea come from? How did it come to life? Every NFT has a story. Tell the world why
							this song is close to your heart.
						</BlogContent>
						...
						/>
						<BlogContent>
							Finally provide the number of copies you want to create and the price of each copy (in Matic). You can also add collaborators to
							your NFT and decide the percentage split among the collaborators.
						</BlogContent>
						<BlogNoteContent>
							<ContentBold>Note:</ContentBold>
							If you’re part of a band, you can mint NFTs of songs collectively as a band, but first, you need to create a band profile for that.
							Follow our guide to know{" "}
							<BlogLink link="https://medium.com/@musixverse/how-to-create-a-band-profile-on-musixverse-1f627b5a91e7">
								how to create a band profile on Musixverse
							</BlogLink>
							.
						</BlogNoteContent>
						<BlogContent>
							...
							<br />
							<br />
							You can also schedule the launch of your NFT in case you don’t want to launch it right away. Once you’re done reviewing these
							details, click the Create button.
						</BlogContent>
						<BlogSubHeading>Congrats, you’ve just minted your first NFT on the Polygon Blockchain!</BlogSubHeading>
						<BlogNoteContent>
							<ContentBold>Suggestion:</ContentBold> Although you can create an NFT on Musixverse in a few minutes, we suggest to take your time
							to go through all the details. Note that you can always save your draft and come back to it any time you want.
						</BlogNoteContent>
						<AboutUs />
					</div>
				</div>
