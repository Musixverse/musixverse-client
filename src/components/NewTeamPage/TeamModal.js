...
export default function Example({ showModal, setShowModal, memberImage, title, fullName, role, socialLinks, description, dob, profileTrack }) {
						...
						>
							<Dialog.Panel className="relative overflow-hidden text-left transition-all transform bg-transparent rounded-lg shadow-xl sm:my-8 sm:max-w-2xl sm:w-full">
								...
								<div className="px-4 py-3 pt-0 dark:backdrop-blur-[7px] backdrop-blur-[7px] bg-[rgba(255,255,255,0.7)] dark:bg-[rgba(255,255,255,0.06)] sm:px-6 sm:flex sm:flex-row-reverse">
									<button
										type="button"
										className="inline-flex justify-center w-full px-4 py-2 mt-3 text-base font-medium text-gray-700 rounded-md shadow-sm focus:outline-none dark:text-light-200 bg-light-100 hover:bg-light-200 dark:bg-dark-600 hover:dark:bg-dark-800 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
