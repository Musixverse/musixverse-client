        ...
        <div className="flex flex-col w-full pt-28">
            <div className="relative rounded-[2.5rem]">
                ...
                <div className="absolute w-full h-full items-center pt-10 md:pt-0 justify-end flex flex-col z-[1]">
                    ...
                    <h1 className="font-semibold opacity-[0.6] text-4xl md:block hidden md:text-[3rem] xl:text-[3.75rem] leading-[1.5] -mb-5 text-[#f2f2f2] lg:mr-startAsArtist2XlHeading">Get Started as<br/> an Artist</h1>
