export const gettingStarted =[
    ...
    },
    {
        ...
        body: "As a collector, you need to have a crypto wallet and love for music & music NFTs.",
    ...
    },
    {
        ...
        body: (
            <>
                <p>After you signup to MXV as an artist, you’ll automatically get redirected to the Artist Verification page, you can verify your profile there with the help of on-screen instructions. 
                <br />
                Otherwise, you can head on to the Artist Verification page. Provide details including your real name, stage name, and government-issued ID, and then connect your Twitter account to get verified.</p>
            </>
        ),
...
export const buyNFT=[
    ...
    },
    {
        ...
        body: "When you buy an NFT from an artist, you receive the royalty each time when the NFT is traded.",
        content_id: "collapseFour",
    },
    {
    ...
    },
    {
        ...
        body:"You need to pay for 2 things to buy an NFT- the cost of NFT and the gas fees. The cost of the NFT is decided by the NFT creator or the collector who is reselling the NFT. The gas fee is around  ₹1 (0.8 MATIC).",
        content_id:"collapseSeven",
    },
];
...
export const sellNFT=[
    ...
    },
    {
        ...
        body: "By default when you create an NFT, it’s up for sale on the NFT Marketplace. And if you own any NFT, you can put it for sale anytime.",
        content_id: "collapseThree",
    },
    {
        heading: "What happens when I sell an NFT?",
        body: "Describe how the NFT will disappear from your profile and MATIC will be added to your profile.",
        content_id: "collapseFour",
    },
    {
    ...
    },
    {
        ...
        body: "It doesn’t cost anything to sell an NFT. You just need to pay the gas fees for the transaction and the gas fee is almost negligible.",
...
export const createNFT=[
    ...
    },
    {
        ...
        body: "It costs around ₹1 (0.8 MATIC) to create/mint an NFT.",
        content_id: "collapseFive",
    },
];