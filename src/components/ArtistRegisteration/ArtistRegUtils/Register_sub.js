    ...
    return(
        <div className="flex bg-light-100 space-x-4 rounded-md p-3">
            ...
            <div>
                ...
                <p className="text-[15px] font-secondary">{artist? 'An Artist can Buy & Browse NFTs<br />but cannot Sale any':'A Collector can Buy & Browse NFTs and<br />also Sell any NFT'}</p> 
            </div>
