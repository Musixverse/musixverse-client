...
export default function GetStartedFan() {
	...
	return (
		<div className="rounded-[1.5rem] md:p-0 p-4 lg:rounded-[2.5rem] xl:rounded-[3.5rem] flex flex-col md:flex-row-reverse md:items-center bg-light-100 dark:bg-[#202020] mt-8 mb-28">
