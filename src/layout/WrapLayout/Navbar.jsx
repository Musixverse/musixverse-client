            ...
            <div className="flex flex-wrap items-center sticky justify-center w-full max-w-[1500px] px-16 py-4">
                <Link href="/">
                    <a href="#" className="flex">
                        {theme === "light" ? (
                            <Image src={logoBlack} alt="MXV Logo" width="100" height="20" />
                        ) : (
                            <Image src={logoWhite} alt="MXV Logo" width="100" height="20" />
                        )}
                    </a>
                </Link>
                            ...
                            <ul className="relative group dropdown">
                                ...
                                >
                                 {isAuthenticated && user ? (
                                    <div className="flex px-4 py-2 text-sm items-center justify-center rounded-full bg-search-100 dark:bg-search-200">
                                        <span className="mr-4">Mathew S.</span>
                                        <Image src={navIcon1} alt="avatar" width="24" height="24" />
                                    </div>
                                 ):(
                                    <div className="flex px-10 py-2 font-semibold text-base items-center justify-center rounded-full bg-search-100 dark:bg-search-200">
                                        Sign in 
                                    </div>    
                                 )}   
                                </a>
                                ...
                                >
                                    ...
                                    <li>
                                        {theme === "dark" ? (
                                            <div className="flex justify-between px-4 items-center w-full rounded-full bg-search-100 dark:bg-search-200">
