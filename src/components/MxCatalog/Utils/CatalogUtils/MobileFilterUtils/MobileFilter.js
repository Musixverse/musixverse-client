...
export default function MobileFilter({showMobileFilter, setShowMobileFilter}){
    ...
    return(
        <>
            {/* Filter Button */}
            <div onClick={()=>setShowMobileFilter(true)} className="mb-[35px] flex items-center justify-center px-8 py-2 rounded-lg cursor-pointer lg:hidden bg-light-300 dark:bg-search-200">
