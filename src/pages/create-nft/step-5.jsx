                        ...
                        <form class="w-full max-w-lg">
                            ...
                            <div class="flex flex-wrap -mx-3 mb-6">
                                <div class="w-full px-3">
                                    <label htmlFor="resale-royalty-percentage" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                            ...
                            <div class="flex flex-col mb-6 mt-4">
                                <span class="text-gray-900">Schedule your NFT launch</span>
                                <div class="mt-2 text-gray-700">
                                    <label class="inline-flex items-center cursor-pointer">
                                        <input type="radio" class="form-radio" name="schedule" value="Schedule Now" />
                                        <span class="ml-2">Schedule Now</span>
                                    </label>
                                    <label class="inline-flex items-center cursor-pointer ml-6">
                                        <input type="radio" class="form-radio" name="schedule" value="Schedule for some time in the future" />
                                        <span class="ml-2">Schedule for some time in the future</span>
                                    </label>
                                </div>
                            </div>
                        </form>
