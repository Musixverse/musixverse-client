	...
	return (
		<div className="pt-8 min-h-screen flex flex-col justify-center items-center">
			<div className="p-6 rounded-2xl bg-white dark:bg-dark-100">
				<span className="flex justify-center items-center w-14 h-14 border-2 rounded-full border-error-200">
			...
			<div className="flex gap-4 mt-20">
				<button className="px-8 py-3 mt-6 font-semibold text-black text-xs bg-light-300/60 hover:bg-light-300 font-primary rounded-xl dark:bg-dark-100 dark:text-white">
					Back
				</button>
				<button className="px-8 py-3 mt-6 font-semibold text-xs text-white bg-primary-100 hover:bg-primary-200 font-primary rounded-xl">
