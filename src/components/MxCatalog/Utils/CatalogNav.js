...
export default function CatalogNav({ currentSelection, setCurrentSelection }) {
	...
	return (
		<div className="flex flex-col items-center justify-center w-full h-[300px] bg-light-300 dark:bg-dark-100">
			...
			<ul className="flex mt-8 space-x-12 font-semibold">
				<li
					className={
						(currentSelection === 1 ? "text-black dark:text-light-100" : "text-[#7B7B7B] hover:text-dark-100 dark:hover:text-light-300") +
						" cursor-pointer"
					}
				>
				...
				<li
					className={
						(currentSelection === 2 ? "text-black dark:text-light-100" : "text-[#7B7B7B] hover:text-dark-100 dark:hover:text-light-300") +
						" cursor-pointer"
					}
				>
