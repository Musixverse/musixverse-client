...
export default function StayInLoop(){
    return(
        <div className="flex flex-col justify-between w-full px-6 md:px-8 lg:px-16 xl:px-20 2xl:px-36 py-16 mt-16 lg:flex-row backdrop-blur-[12px] backdrop-brightness-150">
            {/* Left div */}
