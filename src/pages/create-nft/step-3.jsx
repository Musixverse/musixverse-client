                        ...
                        <form class="w-full max-w-lg">
                            <div class="flex flex-wrap -mx-3 mb-6">
                                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                    <label htmlFor="track-origin" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                                ...
                                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                    <label htmlFor="genre" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                                        Genre
                                    </label>
                                    <div class="relative">
                                        <select
                            ...
                            <div class="flex flex-wrap -mx-3 mb-6">
                                ...
                                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                    <label htmlFor="explicit-content" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                                        Explicit Content
                                    </label>
                                    <div class="relative">
                                        <select
                            ...
                            <div class="flex flex-col mb-6 mt-4">
                                <span class="text-gray-900">Does this track contain any singing, rapping, or other vocals?</span>
                                <div class="mt-2 text-gray-700">
                                    <label class="inline-flex items-center cursor-pointer">
                                        <input type="radio" class="form-radio" name="vocals" value="Yes" />
                                        <span class="ml-2">Yes</span>
                                    </label>
                                    <label class="inline-flex items-center cursor-pointer ml-6">
                                        <input type="radio" class="form-radio" name="vocals" value="No" />
                                        <span class="ml-2">No</span>
                                    </label>
                                </div>
                            </div>
                            <div class="flex flex-col mb-6 mt-4">
                                <span class="text-gray-900">Do you want to add other contributors?</span>
                                <div class="mt-2 text-gray-700">
                                    <label class="inline-flex items-center cursor-pointer">
