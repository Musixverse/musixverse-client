                ...
                <div className="flex md:order-2 ml-auto">
                    {isAuthenticated && user ? (
                        ...
                        <>
                            <button
                                type="button"
                                className="px-5 py-2 rounded-lg text-sm font-medium text-white bg-primary-100 hover:bg-primary-300 active:bg-grey-900 focus:outline-none transition-all"
                                onClick={() => setShowLoginModal(true)}
                            >
                                Authenticate
                            </button>
                            <div className="theme-toggle flex justify-center items-center ml-4">
                                <input type="checkbox" className="" onClick={() => setTheme(theme === "dark" ? "light" : "dark")} />
                            </div>
                        </>
                    )}
                </div>
