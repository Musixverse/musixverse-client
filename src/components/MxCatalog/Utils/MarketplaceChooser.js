...
const MarketplaceChooser = () => {
	...
	useEffect(() => {
		if (router.pathname.startsWith("/mxcatalog/new-releases")) setActive("new-releases");
		else if (router.pathname.startsWith("/mxcatalog/explore")) setActive("explore");
	}, [router.pathname]);
		...
		<div className="flex flex-col w-full justify-center pt-16 pb-24 dark:bg-dark-200">
			<div className="flex justify-center">
				<ul className="nav nav-tabs flex flex-row space-x-8">
					...
					<li className="nav-item flex-auto text-center">
						<Link href="/mxcatalog/explore" passHref>
							<a
								className={
									active == "explore"
