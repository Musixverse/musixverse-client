export default function RadioButton({ radioState, setRadioState, radioType, radioId1, radioLabel1, radioId2, radioLabel2, setCurrentFilterType }) {
	return (
		<div className="flex items-center my-2 space-x-5">
			<div className="flex items-center">
				<input
					...
					className="hidden"
					onClick={() => {
						setRadioState({ type: radioType, selectedChoice: radioId1 });
			...
			<div className="flex items-center">
				<input
					...
					className="hidden"
					onClick={() => {
						setRadioState({ type: radioType, selectedChoice: radioId2 });
						setCurrentFilterType(0);
					}}
