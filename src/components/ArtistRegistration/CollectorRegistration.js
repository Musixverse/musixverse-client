        ...
        <div className={styles["register"]}>
            <div className={styles["register__container"]}>
                ...
                <div className="max-w-[30vw]">
                    ...
                    <p className="text-[15px] font-secondary mt-4">Thanks for signing up as an Collector!</p>
                    <p className="text-[15px] font-secondary mt-4 max-w-[650px]">
                ...
                <RightSection>
                    ...
                    <div className="flex mt-8 text-[16px] font-secondary font-bold space-x-3">
                        <div>
                            <p>Username</p>
                            <input type="text" className="p-1 border-2 border-gray-500 rounded-md shadow-sm" />
                        </div>
                        <div>
                            <p>Email Address</p>
                            <input type="text" className="p-1 border-2 border-gray-500 rounded-md shadow-sm" />
                    ...
                    <div className="flex flex-col mt-8">
                        ...
                        <p className="text-[13px] font-secondary max-w-[468px]">
                            Confirm that you are providing permissions to Musixverse to use your music for non-monetized streaming, both on Musixverse and any
                            external apps and platforms which are directly associated with or part of the Musixverse platform.
                        </p>
