                ...
                <div className="flex font-primary justify-between border-t-2 border-b-2 border-[#afafaf] w-full py-8">
                    <div className="flex flex-col space-y-2">
                        ...
                        <ul className="space-y-2">
                            <li className="hover:text-primary-100"><Link href="/" className="links">Home</Link></li>
                            <li className="hover:text-primary-100"><Link href="/library">Explore</Link></li>
                            <li className="hover:text-primary-100"><Link href="/trending">Trending</Link></li>
                            <li className="hover:text-primary-100"><Link href="/create-nft">Create</Link></li>
                            <li className="hover:text-primary-100"><Link href="/cfh/cfb">Community</Link></li>
                        </ul> 
                    </div>
                    <div className="flex flex-col space-y-2">
                        <p className="font-semibold text">Account</p>
                        <ul className="space-y-2">
                            <li className="hover:text-primary-100">{user && isAuthenticated && <Link href={`/profile/${user.attributes.username}`}>Profile</Link>}</li>
                            <li className="hover:text-primary-100"><Link href="/">Dashboard</Link></li>
                            <li className="hover:text-primary-100"><Link href="/404">Transactions</Link></li>
                    ...
                    <div className="flex flex-col space-y-2">
                        ...
                        <ul className="space-y-2">
                            <li className="hover:text-primary-100"><Link href="/contact-us">Contact Us</Link></li>
                            <li className="hover:text-primary-100"><Link href="/faq">FAQ</Link></li>
                            <li className="hover:text-primary-100"><Link href="/404">Help</Link></li>
                            <li className="hover:text-primary-100"><Link href="/report-a-bug">Report a Bug</Link></li>
                        </ul>   
                    </div>
                    <div className="flex flex-col space-y-2">
                        <p className="font-semibold text">Resources</p>
                        <ul className="space-y-2">
                            <li className="hover:text-primary-100"><Link href="/404">Blogs</Link></li>
                            <li className="hover:text-primary-100"><Link href="/404">Docs</Link></li>
                            <li className="hover:text-primary-100"> <Link href="/404">Media Kit</Link></li>
                            <li className="hover:text-primary-100"><Link href="/404">Partners</Link></li>
                        </ul>
                    </div>
                    <div className="flex flex-col space-y-2">
                        <p className="font-semibold text">General</p>
                        <ul className="space-y-2">
                            <li className="hover:text-primary-100"><Link href="/">About Us</Link></li>
                            <li className="hover:text-primary-100"><Link href="/team-page">Team</Link></li>
                            <li className="hover:text-primary-100"><Link href="/404">Careers</Link></li>
                            <li className="hover:text-primary-100"><Link href="/404">MXV Greenpaper</Link></li>
                        </ul>
                    </div>
                </div>
