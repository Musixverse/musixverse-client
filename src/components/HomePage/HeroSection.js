...
export default function HeroSection(){
    return(
        <div className="w-screen relative bg-[#131313] pt-[150px] flex flex-col items-center justify-center">
            {/* Intro */}
            <div className="flex flex-col items-center h-[600px] font-primary absolute z-[7] pt-[5.5rem]">
                <h3 className="text-4xl font-medium">save the date, for your music</h3>
                <h1 className="z-[1] font-medium text-[9.125rem] leading-none">24 October it is</h1>
                <div className="absolute z-[2] w-[457px] h-[457px] top-[10rem]">
