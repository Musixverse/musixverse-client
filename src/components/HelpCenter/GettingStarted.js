...
export default function GettingStarted() {
	...
	const gettingStartedAccordion = gettingStarted.map((elem, idx) => {
		return (
	...
	return (
		<div className="self-start w-full p-12 pb-16 dark:bg-dark-600 bg-light-100 rounded-xl">
			...
			<h3 className="mb-5 text-lg text-center font-medium sm:text-3xl text-primary-600">Getting Started</h3>
