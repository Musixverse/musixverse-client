...
export const buyNFT = [
    ...
    },
    {
        ...
        body: (
            <>
                <p>If Person A buys an NFT from Person B for an amount TOTAL, then:
                    <br />
                    <br />
                    1% -&gt; Platform Fee  (or  0.1% -&gt; Sharer/Referrer & 0.9% -&gt; Platform Fee)
                    <br />
                    &lt;ROYALTY_PERCENTAGE&gt; -&gt; Artist
                    (100 - ROYALTY_PERCENTAGE - Platform Fee)% -&gt;  Person B
                </p>
            </>
        ),
        content_id: "collapseSix",
...
export const createNFT = [
    ...
    },
    {
        ...
        body: (
            <>
                <ul className="list-disc pl-4">
                    <li><strong>Price & Quantity:</strong> The general rule of thumb is – the more the quantity, the lower the price, the fewer the quantity, the higher the price. Set the price for your NFTs with humility, but raise the floor price steadily and consistently as the market responds. Musixverse recommends limiting the quantity to create exclusivity.</li>
                    <li><strong>Royalty Percentage:</strong> There’s no bar on the royalty percentage that you want to give to your NFT collectors. However, we recommend keeping it between 2% to 5%.</li>
                    <li><strong>Collaborators:</strong> Include all the collaborators who worked with you while creating a song. If they haven’t already signed up yet, don’t forget to invite them. You will find an option to invite them while creating the NFT. While you will not be able to complete NFT creation until they are on the platform, we will save your progress for you to pick up where you left.</li>
                    ...
                    <li><strong>Audio File:</strong>
                        <ul className="list-disc pl-4">
                            <li>File types supported: Any audio file</li>
                            <li>Max file size: 1 GB</li>
                        </ul>
                    </li>
                    <li><strong>Links to music platforms:</strong> Provide links of the song that you already released to the streaming platforms like Spotify, Apple Music, etc</li>
                </ul>
            </>
        ),
        content_id: "collapseFour",
