	...
	return (
		<div className="flex flex-col justify-between h-full">
			<div>
				...
				<p className="text-[13px] sm:text-[15px] font-secondary">What&apos;s the difference Between Artist & Collectors?</p>
				...
				<div className="flex items-start mt-12 space-x-3">
					...
					<p className="text-[13px] font-secondary">
						Don&apos;t worry, you can switch your collector profile to an artist profile at any stage you&apos;d like.
					</p>
				</div>
			</div>
