...
const whatDoINeedData = [{
    ...
    body: 
        <>
            ...
            <p>Your public wallet address (e.g. 0x48b7cedF1D50cE6595a027c9234D5e5Bef54E09C) is a unique identifier for your wallet. It&apos;s like your bank account number and people can transfer funds to this address.</p>
        </>,
    content_id: "collapseTwo"
},{
...
const buyingAndSellingData = [{
    ...
    body: "You can go to the Song Info page and put up the NFT on sale. If any buyer is interested in purchasing the NFT for the price that you have specified, then they can just buy it from you and it will be sold.",
    content_id: "collapseFour"
},{
    heading: "I sold a song NFT. Where’s my MATIC?",
    ...
    heading: "Would the creator of the song have any distribution rights after the trade has occurred and they have sold it to someone else?",
    body: "Yes, the distribution rights will remain with the artist and they will have full control over the song.",
    content_id: "collapseNine"
},{
    heading: "What are the rights of a buyer after buying the NFT?",
    body: "The buyer can use the song anywhere they want, but not for monetary benefits. The buyer just owns a copy of the song (i.e. the NFT), not the song itself.",
