    ...
    return(
        <div className="flex flex-col w-full pt-16">
            <div className="relative rounded-[2.5rem]">
                <div className="hidden md:flex absolute z-[2] pl-36 h-[470px] w-[506px] top-[-31%]">
                ...
                <div className="absolute w-full h-full items-center justify-between pt-10 md:pt-0 md:justify-end flex flex-col z-[1]">
                    <h1 className="font-semibold opacity-[0.6] text-4xl md:text-7xl md:-mb-7 text-[#f2f2f2]">Get Started as<br/> an Artist</h1>
