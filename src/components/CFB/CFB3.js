    ...
    return (
        <div className={styles["cfb3__container"]}>
            ...
            <p className="font-secondary text-sm max-w-xs sm:max-w-2xl text-center pt-6">
                Everything that we are doing today is going to power the decentralized world of tomorrow. Establishing ownership of these assets will be key to
                what you can and cannot do in the Metaverse!
            </p>
        </div>
    );
}
