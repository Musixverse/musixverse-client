...
export default function CFB1(){
    return(
        <div className={styles['cfb1__container']}>
           <p className="font-primary font-semibold text-3xl text-primary-200">MXV COMMUNITY FEEDBACK BOARD</p>
           <p className="font-secondary text-xs max-w-2xl text-center pt-6">
            ...
            <div className={styles['cfb1__card']}>
                <div className={styles['cfb1__card--innercard']}>
                    <p className="font-primary font-semibold text-3xl">The Problem with Music Industry</p>
