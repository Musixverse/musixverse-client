		...
		body: (
			<>
				<ol className="list-decimal pl-4">
					<li>
						Currently Musixverse NFTs come with a limited license for non-commercial use of the music file or the album art packaged in the NFT.
					</li>
...
export const community = [
	{
		...
		body: (
			<>
				<p>
					Yes, we do have an official Twitter handle and Discord Community.
					<br />
				...
				<ul className="list-disc pl-4">
					<li>
						<span className="font-medium underline underline-offset-2 text-primary-500">
							<Link href="https://twitter.com/musixverse">Click here to connect on Twiiter</Link>
						</span>
					</li>
					<li>
						<span className="font-medium underline underline-offset-2 text-primary-500">
							<Link href="https://discord.com/invite/rXKb7rCqjG">Click here to join our Discord Server</Link>
						</span>
					</li>
				</ul>
			</>
		...
		body: (
			<>
				<p>
					...
					<span className="font-medium underline underline-offset-2 text-primary-500">
						<Link className="font-medium underline underline-offset-2 text-primary-500" href="https://linktr.ee/musixverse">
							Connect With Us
						</Link>
					</span>
				</p>
	...
	},
	{
		...
		body: (
			<>
				<p>
					You can connect with the Musixverse team via the{" "}
					<span className="font-medium underline underline-offset-2 text-primary-500">
						<Link href="/contact-us">Contact Us page</Link>
					</span>{" "}
					or you can also email us at{" "}
					<span className="font-medium underline underline-offset-2 text-primary-500">
						<Link href="mailto:contact@musixverse.com">contact@musixverse.com</Link>
					</span>
				</p>
			</>
		),
...
//         body: (
//             <>
//                 <p className="text-sm text-primary-600 sm:text-base">Can I play on a mobile device?</p>
//                 <p>
...
//                 </p>
//                 <p className="mt-5 text-sm text-primary-600 sm:text-base">Can I log in from multiple computers?</p>
...
//         body: (
//             <>
//                 <p className="text-sm text-primary-600 sm:text-base">Installing your digital wallet</p>
...
//                 </ul>
//                 <p className="mt-5 text-sm text-primary-600 sm:text-base">What is a “wallet address”?</p>
//                 <p>
...
//         body: (
//             <>
//                 <p className="text-sm text-primary-600 sm:text-base">What is MATIC? Why do I need it?</p>
//                 <ul className="mt-1 list-disc pl-4">
//                     <li>
...
//                 <ul className="list-disc pl-4">
//                     <li>
//                         You can contact us at <span className="font-medium text-primary-700">contact@Musixverse.com</span>. Please include any relevant NFT IDs,
...
//         body: (
//             <p>
//                 You can contact us at <span className="font-medium text-primary-700">contact@Musixverse.com</span>. Please include any relevant NFT IDs, links,
