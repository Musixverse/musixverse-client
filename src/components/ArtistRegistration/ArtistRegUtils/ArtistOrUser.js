...
import Notification_icon from "../../../../public/assets/registration/Notification.svg";
            ...
            <div>
                ...
                <div className="flex items-start mt-12 space-x-4">
                    ...
                    <p className="text-[12px] font-secondary">
                        Don&apos;t worry, you can switch your user profile to <br />
                        an artist profile at any stage you&apos;d like.
                    </p>
                </div>
            </div>
