...
export default function LockAccount(){
    return(
        <>
            ...
            <div className={"dark:border-dark-200 dark:bg-dark-200 dark:hover:border-primary-100 flex max-w-fit sm:w-auto ml-0 mt-3 sm:mt-0 items-center px-4 py-2 bg-white border-2 rounded-xl hover:border-primary-100"}>
                <p className={"dark:text-light-100 mt-[1px] text-sm font-medium text-gray-700"}>Your Issue: </p>
                <HelpDropdown/>
            </div>
            <div className="flex items-baseline my-6">
                <input type={"checkbox"}></input>
                <p className="ml-2 font-secondary align-top text-[15px]">Confirm that you agree to all terms, conditions, and policies of Musixverse. <a href="#" className="font-medium text-primary-100">Terms and conditions.</a></p>
            </div>
