        ...
        <div className={styles['cfb5__container']}>
            <div className={"dark:bg-dark-100 "+styles['cfb5__card']}>
                <div className="self-start lg:self-center">
                    ...
                    <a href="mailto:info@musixverse.com" className="text-sm font-primary text-primary-200">info@musixverse.com</a>

                    <p className="py-6 text-sm font-secondary">Tap the button to join our
                    <br />Musixverse Community Feedback Board
                    </p>
                    <button className="px-20 py-3 mt-2 text-xs text-white bg-primary-200 hover:bg-primary-300 font-primary rounded-xl">Join Now</button>
