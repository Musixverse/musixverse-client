		...
		<div className="flex flex-col w-full py-28">
			<div className="relative rounded-[2.5rem]">
				...
				<div className="absolute w-full h-full items-center justify-end pt-10 md:pt-0 md:justify-end flex flex-col z-[1]">
					<h1 className="font-semibold opacity-[0.7] text-5xl md:text-[3rem] xl:text-[3.75rem] leading-[1.5] -mb-5 md:block hidden text-light-200 md:text-[#032C2D] md:mr-auto pl-startAsFan2XlHeading">
						Get Started as
						<br /> a Fan
					</h1>
