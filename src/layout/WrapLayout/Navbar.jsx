            ...
            <nav className={"navbar duration-300 ease-in mx-auto "+ customStyles}>
                <div className="flex flex-wrap items-center justify-center w-full px-16 py-4">
                    ...
                    <div className="block ml-10">
                        <ul className="flex flex-row items-center font-semibold md:text-base md:space-x-8 md:mt-0 sm:text-sm">
                            ...
                            <li>
                                <ul className="relative group dropdown">
                                    ...
                                    >
                                        ...
                                        <li>
                                            {theme === "dark" ? (
                                                <div className="flex items-center justify-between w-full px-4 rounded-full bg-search-100 dark:bg-search-200">
