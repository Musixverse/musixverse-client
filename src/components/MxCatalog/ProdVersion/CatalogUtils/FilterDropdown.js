...
export default function FilterDropdown({ optionsArray, initialValue, setChoice, dropdownType}) {
    ...
    return (
        <Menu as="div" className="relative inline-block w-full text-left">
            ...
            <div>
                <Menu.Button className={"dark:bg-[#323232] bg-[#D9D9D9] hover:dark:border-[#6cc027] dark:text-light-100 dark:border-[#323232] inline-flex justify-between text-sm font-medium text-[#383838]  border-2 border-transparent w-full px-4 py-2 rounded-md hover:border-[#6cc027]"}>
