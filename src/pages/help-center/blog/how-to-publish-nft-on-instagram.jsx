				...
				<div className="overflow-x-hidden justify-center w-full max-w-[768px] px-6 md:px-8 lg:px-0">
					<div className="py-36">
						...
						<BlogNoteContent>
							...
							You can follow this <BlogLink link="https://musixverse.com/help-center/blog/how-to-buy-nft-on-musixverse">step-by-step guide to buy an NFT on Musixverse</BlogLink>.
						</BlogNoteContent>
