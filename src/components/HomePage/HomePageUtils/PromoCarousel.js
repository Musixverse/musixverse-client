...
export default function PromoCarousel() {
	...
	const imgSrcs_lightTheme = [
		...
		{artistName:"Aditya Kalwal",imgSrc: "/assets/homepage/slider/adityaFull_w.png"}
	]
	...
	const handleTouchMove = (evt) => {
		...
		if (Math.abs(xDiff) > Math.abs(yDiff)) {
			...
			if (xDiff <= 0) {
				/* left swipe */
				setCurrSlide((prev)=>{return prev === 1? 8:prev-1});
			} else {
				/* right swipe */
				setCurrSlide((prev)=>{return prev === 8? 1:prev+1});
			}
		}
		/* reset values */
		xDown = null;
	...
	return (
		<div className={styles['wrapper-container']}>
			...
			<div className="flex-1 mb-20 md:mb-0 md:-mt-20 promo-carousel-container" id="slider">
				...
				{/* {labels} */}
				<label onTouchStart={handleTouchStart} onTouchMove={handleTouchMove} onClick={(e)=>{handleNftCardClick(e, 1)}} htmlFor="s1" id="slide1"><ArtistIntro artistName={"Harry Arora"}/></label>
				<label onTouchStart={handleTouchStart} onTouchMove={handleTouchMove} onClick={(e)=>{handleNftCardClick(e, 2)}} htmlFor="s2" id="slide2"><ArtistIntro artistName={"Xubaan"} isBand={true}/></label>
				<label onTouchStart={handleTouchStart} onTouchMove={handleTouchMove} onClick={(e)=>{handleNftCardClick(e, 3)}} htmlFor="s3" id="slide3"><ArtistIntro artistName={"Jatayu"} isBand={true}/></label>
				<label onTouchStart={handleTouchStart} onTouchMove={handleTouchMove} onClick={(e)=>{handleNftCardClick(e, 4)}} htmlFor="s4" id="slide4"><ArtistIntro artistName={"Sarthak Kalyani"}/></label>
				<label onTouchStart={handleTouchStart} onTouchMove={handleTouchMove} onClick={(e)=>{handleNftCardClick(e, 5)}} htmlFor="s5" id="slide5"><ArtistIntro artistName={"Pooja Tiwari"}/></label>
				<label onTouchStart={handleTouchStart} onTouchMove={handleTouchMove} onClick={(e)=>{handleNftCardClick(e, 6)}} htmlFor="s6" id="slide6"><ArtistIntro artistName={"Sommaiya"}/></label>
				<label onTouchStart={handleTouchStart} onTouchMove={handleTouchMove} onClick={(e)=>{handleNftCardClick(e, 7)}} htmlFor="s7" id="slide7"><ArtistIntro artistName={"Submarine In Space"} isBand={true}/></label>
				<label onTouchStart={handleTouchStart} onTouchMove={handleTouchMove} onClick={(e)=>{handleNftCardClick(e, 8)}} htmlFor="s8" id="slide8"><ArtistIntro artistName={"Aditya Kalwal"}/></label>
