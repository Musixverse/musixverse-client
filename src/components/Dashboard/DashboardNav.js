...
export default function DashboardNav(){
    return(
        <div className="dark:bg-dark-100 lg:mb-0 mb-8 lg:block md:flex md:justify-between p-8 xl:pl-10 xl:py-10 lg:pr-dashboardNav bg-light-300 rounded-xl max-h-[350px] lg:mr-12 xl:mr-16">
            <h1 className="mb-6 text-3xl md:mb-0 xl:text-4xl font-tertiary lg:mb-9">DASHBOARD</h1>
