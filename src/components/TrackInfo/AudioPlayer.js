...
export default function AudioPlayer({numberOfCopies, tokenId, audio, artistName, isArtistVerified, trackName, image, trackId, price }) {
	/*******************************
	 *******  AUDIO PLAYER  ********
	 *******************************/
	...
	return (
		<div className="flex flex-col items-center justify-evenly sm:flex-row sm:justify-between sm:items-center">
			...
			<div className="flex flex-col sm:ml-5 sm:flex-grow">
				...
				<Actions tokenId={tokenId} coverArt={image} numberOfCopies={numberOfCopies} artistName={artistName} title={trackName} />
			</div>
		</div>
	);
}
