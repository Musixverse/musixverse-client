	...
	return (
		<div className="contact_us_container">
			<div className="contact_us">
				<div>
					<div className={styles["contact_us_heading"]}>Report a Bug</div>
				</div>
				...
				<div className="mt-4 font-primary text-[#afafaf]">
					<div>
						...
						<br />
						<a href="mailto:contact@musixverse.com?subject=[Bug%20Report]" target="_blank" rel="noopener noreferrer" className="font-primary text-[#afafaf]">
