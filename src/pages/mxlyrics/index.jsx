		...
		<>
			...
			<div className="flex items-center justify-center bg-light-200 dark:bg-dark-1000">
				<div className="lg:flex-row flex-col flex w-full max-w-[1920px] pb-40 px-6 md:px-8 lg:px-16 xl:px-20 2xl:px-36">
					<div className="w-full gap-x-48 h-screen overflow-scroll no-scrollbar flex flex-col md:flex-row items-center justify-center m-0 p-0">
						<form
							onSubmit={(e) => {
								e.preventDefault();
						...
						>
							<p className="text-[105px] text-center font-bold -tracking-2">
								M<span className="text-primary-400 text-[90px]">x</span> L<span className="text-[90px]">yrics</span>
							</p>
							<h1 className="text-xl text-center font-semibold -mt-2">say goodbye to creative blocks</h1>

							<div className="mt-16 flex justify-between text-sm">
								<span
									className={
										"px-8 py-3 bg-primary-100 dark:bg-dark-800 rounded-full cursor-pointer border " +
