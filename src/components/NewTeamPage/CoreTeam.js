...
export default function CoreTeam(){
    ...
    /**
     * name, memberImage, uploadedSong, nftPrice, numberOfCopies, socials, user
    ...
    const coreTeam = [
		{
			...
			role: "Lead Developer",
            dob: "2207",
			profileSong: "/sounds/TeamPage/Pushpit.mp3",
			socialLinks: {
		...
		},
		{
            ...
            dob: "2103",
			profileSong: "/sounds/TeamPage/Yuvraj.mp3",
			socialLinks: {
		...
		},
		{
			...
			profileSong: "/sounds/TeamPage/Sparsh.mp3",
			socialLinks: {
		...
		},
		{
			...
			profileSong: "/sounds/TeamPage/ShivamTemp.mp3",
			socialLinks: {
		...
		},
		{
			...
			role: "Core Developer",
            dob:"0110",
			profileSong: "/sounds/TeamPage/Ayush.mp3",
			socialLinks: {
			...
			<div className="flex flex-wrap justify-between w-full mt-10">
				{coreTeam.map((member, idx)=>{
					return(
						<MemberNft
							key={idx}
							{...{...member, setShowModal, currentlyPlaying, setCurrentlyPlaying, idx, setSelectedMember}}
						/>
					);
				})}
			</div>
