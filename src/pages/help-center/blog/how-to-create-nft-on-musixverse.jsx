			...
			<div className="flex flex-col items-center justify-center w-full bg-light-200 dark:bg-dark-800">
				<div className="overflow-x-hidden justify-center w-full max-w-[768px] px-6 md:px-8 lg:px-0">
					<div className="py-36">
						...
						<BlogNoteContent>
							<ContentBold>Note:</ContentBold> <BlogLink link="https://musixverse.com/help-center/blog/musixverse-nft-guidelines">Musixverse NFT Guidelines</BlogLink> is the complementary guide to this article. It describes the standard guideline that you can follow to create your NFTs.
						</BlogNoteContent>
